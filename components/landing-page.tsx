...
export function LandingPage() {
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      {/* Header */}
      <header className="sticky top-0 bg-black/40 backdrop-blur z-20 border-b border-white/[0.04]">
      ...
      <main className="relative z-10 flex items-center justify-center px-6 min-h-[calc(100vh-80px)]">
        <div className="max-w-3xl w-full text-center py-20">
          ...
          <p className="text-base text-zinc-400 mb-12 max-w-md mx-auto font-normal leading-relaxed">
            Cursos de diseño audiovisual para creadores y empresas.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <a
              href="https://wa.me/59178482245"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-400 text-white font-bold px-7 py-6 rounded-full shadow-[0_0_30px_-8px_rgba(16,185,129,0.5)] transition-all"
            >
            ...
            <a
              href="#beneficios"
              className="inline-flex items-center justify-center text-zinc-300 hover:text-white hover:bg-white/5 font-normal px-6 py-6 rounded-full text-lg"
            >
              Ver más
            </a>
          </div>
      ...
      <section id="contacto" className="relative z-10 px-6 py-28 border-t border-white/[0.04]">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-zinc-400 text-base font-normal mb-10 leading-relaxed">
            Mandame un mensaje para ayudarte a mejorar tu marca
          </p>
